...
dados =pd.read_csv('dados/ObesityDataSet_raw_and_data_sinthetic.csv', sep=',')
...
with open("dados/colunas_categoricas.pkl", "wb") as f:
...
dump(modelo_normalizador, open("dados/normalizador.pkl", "wb"))
...
dump(obesity_kmeans_model, open("dados/obesity_cluster.pkl", "wb"))
